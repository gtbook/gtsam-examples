...
class PreintegrationExample:
    ...
    def __init__(self,
        ...
        # Figure numbers for Matplotlib
        self.pose_fignum = pose_fignum
        self.imu_fignum = imu_fignum
    ...
    def plotGroundTruthPose(self,
        ...
        plot_pose3(self.pose_fignum, actualPose, scale)
    ...
    def plot_scenario(self, T, title="IMU trajectory scenario", fignum=None):
        """Plot the `scenario` trajectory over `T` seconds."""
        if fignum is None:
            fignum = self.pose_fignum
    ...
    def run(self, T: int = 12):
        ...
        for i, t in enumerate(np.arange(0, T, self.dt)):
            ...
            if i % 25 == 0:
                ...
                plot_pose3(self.pose_fignum, predictedNavState.pose(), 0.1)
