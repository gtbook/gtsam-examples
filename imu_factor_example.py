...
from preintegration_example import POSES_FIG, PreintegrationExample
...
class ImuFactorExample(PreintegrationExample):
    ...
    def __init__(self,
        ...
        twist_scenarios = dict(
            ...
            forward_motion=(np.zeros(3), self.velocity),
            loop=(np.array([0, -math.radians(30), 0]), self.velocity),
            sick=(np.array([math.radians(30), -math.radians(30),
                            0]), self.velocity))
        ...
        super(ImuFactorExample, self).__init__(twist_scenarios[twist_scenario],
                                               ...
                                               params,
                                               dt,
                                               pose_fignum=pose_fignum,
                                               imu_fignum=imu_fignum)
    ...
    def plot(self,
        ...
        Args:
            ...
            fignum: The matplotlib figure number.
                POSES_FIG is a value from the PreintegrationExample which
                we simply increment to generate a new figure.
